...
from core import getCoursesWithUserFilters
from utilsChat import formatCourseFiltersMessage, formatCourseMessage


def courseList(bot: TeleBot):
    @bot.message_handler(commands=["courselist", "courseList"])
    def handle_check(message):
        ...
        bot.send_message(message.chat.id, formatCourseFiltersMessage(filters))
        ...
        for course in courses:
            response = formatCourseMessage(course) + "\n\n"
